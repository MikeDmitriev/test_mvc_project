...
public class BankServletControllerImpl implements BankServletController {
    ...
    @Override
    @RequestMapping(value = "/new_request", consumes = APPLICATION_JSON_VALUE, /*produces = APPLICATION_JSON_VALUE,*/ method = POST)
    ...
    @Override
    @RequestMapping(value = "/all_request", /*consumes = APPLICATION_JSON_VALUE,*/ produces = APPLICATION_JSON_VALUE, method = GET)
    public List<CardRequestView> viewAllCardRequest() {
        return dbService.getAllRequests();
    }

    @Override
    @RequestMapping(value = "/request", /*consumes = APPLICATION_JSON_VALUE,*/ produces = APPLICATION_JSON_VALUE, method = GET)
    public CardRequestView viewCardRequest(@RequestParam long requestId) {
        return dbService.getCardRequest(requestId);
    }

    @Override
    @RequestMapping(value = "/owner_request", /*consumes = APPLICATION_JSON_VALUE,*/ produces = APPLICATION_JSON_VALUE, method = GET)
    ...
    @Override
    @RequestMapping(value = "/owner_account", /*consumes = APPLICATION_JSON_VALUE,*/ produces = APPLICATION_JSON_VALUE, method = GET)
    ...
    @Override
    @RequestMapping(value = "/owner_card", /*consumes = APPLICATION_JSON_VALUE,*/ produces = APPLICATION_JSON_VALUE, method = GET)
    ...
    @Override
    @RequestMapping(value = "/card", /*consumes = APPLICATION_JSON_VALUE,*/ produces = APPLICATION_JSON_VALUE, method = GET)
    public BankCardView viewCard(@RequestParam long cardId) {
        return dbService.getCardById(cardId);
    }

    @Override
    @RequestMapping(value = "/sign_request", /*consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE,*/ method = GET)
    public boolean signCardRequest(@RequestParam long requestId) {
        return dbService.signRequest(requestId);
    }

    @Override
    @RequestMapping(value = "/send_request", /*consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE,*/ method = GET)
    public boolean sendCardRequest(@RequestParam long requestId) {
        return dbService.sendRequest(requestId);
    }

    @Override
    @RequestMapping(value = "/ready_request", /*consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE,*/ method = GET)
    public boolean readyCardRequest(@RequestParam long requestId) {
        return dbService.readyRequest(requestId);
    }

    @Override
    @RequestMapping(value = "/activate", /*consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE,*/ method = GET)
    public boolean activateCard(@RequestParam long cardId) {
        return dbService.activateCard(cardId);
    }

    @Override
    @RequestMapping(value = "/accounts", /*consumes = APPLICATION_JSON_VALUE,*/ produces = APPLICATION_JSON_VALUE, method = GET)
    public List<AccountView> getAllAccounts(){
        return dbService.getAllAccounts();
    }

    @Override
    @RequestMapping(value = "/owners", /*consumes = APPLICATION_JSON_VALUE,*/ produces = APPLICATION_JSON_VALUE, method = GET)
    public List<OwnerView> getAllOwners(){
        return dbService.getAllOwners();
    }

    @RequestMapping(value = "/owners_id", /*consumes = APPLICATION_JSON_VALUE,*/ produces = APPLICATION_JSON_VALUE, method = GET)
